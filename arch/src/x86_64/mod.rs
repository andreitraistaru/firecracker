...
pub mod layout;
mod mptable;
/// Logic for managing x86_64 model-specific-registers.
pub mod msr;
...
mod tests {
    ...
    fn test_system_configuration() {
        let no_vcpus = 4;
        let gm = GuestMemory::new_anon_from_tuples(&[(GuestAddress(0), 0x10000)], true).unwrap();
        ...
        let gm = GuestMemory::new_anon_from_tuples(&arch_mem_regions, true).unwrap();
